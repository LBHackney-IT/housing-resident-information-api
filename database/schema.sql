...
CREATE TABLE dbo."CCContactLink"(
	"ContactNo" int GENERATED BY DEFAULT AS IDENTITY NOT NULL,
	...
	"UPMFldrNo" int NULL,
	"housingMTenant" Varchar(50) NULL,
	housing_sid char(50) NULL,
	"Tenant" char(20) NULL,
	"Applicant" int NULL,
	"Enquiry" int NULL,
...
CREATE TABLE dbo."CCEmailAddress"(
	"ContactNo" int NOT NULL GENERATED BY DEFAULT AS IDENTITY,
	"Email" varchar(50) NOT NULL,
	"EmailType" varchar(5) NOT NULL,
	"OKToEmail" varchar(5) NOT NULL,
	"Defualt" varchar(5) NOT NULL,
	"EmailID" int GENERATED BY DEFAULT AS IDENTITY NOT NULL PRIMARY KEY,
...
CREATE TABLE dbo."CCPhone"(
	...
	"PhoneID" int GENERATED BY DEFAULT AS IDENTITY NOT NULL PRIMARY KEY,
	"modDate" Timestamp(3) NOT NULL,
	"modUser" varchar(20) NOT NULL,
	"modType" char(1) NOT NULL,
	"modProc" int NULL
...
(
    con_key integer GENERATED BY DEFAULT AS IDENTITY,
    con_ref varchar (12),
    con_name varchar(73),
    con_address varchar (200),
    con_phone1 varchar(21),
    con_phone2 varchar(21),
    con_phone3 varchar(21),
    con_postcode varchar(10),
    con_type varchar(1),
    tag_ref varchar(11),
    prop_ref varchar(12),
    email_address varchar(50),
    app_ref varchar(10),
    contacts_sid  integer default 0,
    intreason varchar(3),
    vunreason varchar(3),
    locreason varchar(3),
    intcomment text,
