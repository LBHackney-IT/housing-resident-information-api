    ...
    public class GetAllResidentsUseCaseTest
    {
        ...
        public void ReturnsResidentInformationList()
        {
            ...
            _mockUHGateway.Setup(x =>
                    x.GetAllResidents(0, 10, "000011", "ciasom", "tessellate", "1 Montage street"))
            ...
            var response = _classUnderTest.Execute(rqp, 0, 10);
        ...
        {
            _mockUHGateway.Setup(x => x.GetAllResidents(0, 10, null, null, null, null))
                .Returns(new List<ResidentInformation>()).Verifiable();

            _classUnderTest.Execute(new ResidentQueryParam(), 0, 10);
        ...
        {
            _mockUHGateway.Setup(x => x.GetAllResidents(0, 100, null, null, null, null))
                .Returns(new List<ResidentInformation>()).Verifiable();

            _classUnderTest.Execute(new ResidentQueryParam(), 0, 500);
        ...
        public void ReturnsTheNextCursor()
        {
            ...
            var expectedNextCursor = stubbedResidents.Max(r => r.HouseReference);
            ...
            _classUnderTest
                .Execute(new ResidentQueryParam(), 0, 10).NextCursor
                .Should()
                .Be(expectedNextCursor);
        }
        ...
        public void WhenAtTheEndOfTheResidentListReturnsTheNextCursorAsEmptyString()
        {
            ...
            _classUnderTest
                .Execute(new ResidentQueryParam(), 0, 10)
                .NextCursor
                .Should()
                .Be("");
        }
